...
least-squares-cpp is a single header-only C++ library for unconstrained non-linear least squares optimization. It provides newton type optimization algorithms such as:

* Gradient Descent
* Gauss Newton
* Levenberg Marquardt

The library also includes the following step size methods:
